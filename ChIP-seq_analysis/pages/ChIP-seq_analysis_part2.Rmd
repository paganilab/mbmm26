...
```{r, eval=TRUE}
recurrence_table <- read.table('../MBMM_uploadata//recurrence_chr12.matrix', sep='\t')
```
...
```{r, eval=TRUE}
tumor_up_res <- read.table('../MBMM_uploadata/Korg_UP_regions_results.txt', sep='\t', header=TRUE, quote = "" )
tumor_down_res <- read.table('../MBMM_uploadata/Ncr_UP_regions_results.txt', sep='\t', header=TRUE, quote = "")
```
